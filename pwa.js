...
const cacheName = 'Fixit8EthanMarchetti-2020-10-04 17:03:21.158995'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'Fixit8EthanMarchetti'.length) === 'Fixit8EthanMarchetti') {
